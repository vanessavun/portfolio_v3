          ...
          <div className="about-section p-4">
            ...
            <div className="flex flex-row p-4">
              <div className="about-text">
                ...
                <p className=" text-indigo-300 font-medium py-4">
                ...
                <p className=" text-blue-300 font-medium py-4">
                ...
                <p className=" text-indigo-300 font-medium py-4 text-lg">
                  Hobbies & interests:
                  <ul className="flex p-4 flex-wrap font-poppins text-base">
                ...
                <p className=" text-indigo-200 font-medium py-4">
                  Developer Skills:
