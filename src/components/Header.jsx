        ...
        <div className="header-area flex justify-center bg-black">
          ...
          <nav className='container'>
            <div className=" flex justify-between py-4 px-1 text-indigo-300">
              {/* Header Navigation */}
              <div className="flex items-center">VV</div>
              <div className="flex items-center">
                <ul className=" hover:text-white text-sm sm:text-base sm:font-semibold flex">
                  ...
                  <li className="mx-4">
                    <a href="https://drive.google.com/file/d/1iNXdgLUF8Up_UMffX3qRT4aVozHki_CX/view?usp=share_link" target="_blank">Resume</a>
                  </li>
                </ul>
              </div>
